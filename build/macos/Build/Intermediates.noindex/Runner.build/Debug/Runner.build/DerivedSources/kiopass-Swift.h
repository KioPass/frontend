...
#ifndef KIOPASS_SWIFT_H
#define KIOPASS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="kiopass",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC7kiopass11AppDelegate")
...
SWIFT_CLASS("_TtC7kiopass17MainFlutterWindow")
